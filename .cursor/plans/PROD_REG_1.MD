...
**R-BOM-2:** User seleLction is source of truth for which lot is consumed (not silent FEFO auto-pick). FEFO may **sort** dropdown (earliest use-by first) but not auto-commit.
