...
urlpatterns = [
    ...
    path('plans/<int:plan_id>/lines/<int:line_id>/', views.plan_line_detail_api, name='planning-plan-line-detail'),
    ...
    path('allocations/<int:allocation_id>/', views.allocation_detail_api, name='planning-allocation-detail'),
    ...
    # Demand profile endpoints
    path('demand-profiles/', views.demand_profiles_collection_api, name='planning-demand-profiles'),
    path('demand-profiles/<int:profile_id>/', views.demand_profile_detail_api, name='planning-demand-profile-detail'),
